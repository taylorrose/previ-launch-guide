...
## Home & Auto Insurance {{ tag: "New!", label: "Employees can now save on their insurance bills." }}
...
## The Drop {{ tag: "New!", label: "Grand opening April 8, 2025" }}
### *Premium Brands featured monthly*
...
- Refer to your [Quickstart Guide](./quickstart) to effectively communicate and promote these benefits to your employees.

Everything you need to confidently introduce and manage employee pricing benefits is clearly structured here—ready for your rollout.