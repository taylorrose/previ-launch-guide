...
|---------------------|-------------------------|------------------------------------------------------------------------------------------------------|----------------------------------------------------|
| 1                   | **Initial Announcement**| Introduces Previ benefit clearly and professionally, establishing legitimacy and value.             | <CommsPreviewLink path="email-preview" commsNumber="1" label="Email Template" /> |
| 2                   | **Deadline Reminder**   | Reinforces urgency by reminding employees of the approaching enrollment deadline.                   | <CommsPreviewLink path="email-preview" commsNumber="2" label="Email Template" /> |
